...
export const THEME_OPTIONS: Array<{
  ...
  { key: 'netflix', label: 'Netflix', description: 'Pure black cinema dark with iconic Netflix red accent.' },
  { key: 'bmw-m', label: 'BMW M', description: 'Carbon-black performance theme with BMW M blue and motorsport red.' },
  { key: 'openai-research', label: 'OpenAI Research', description: 'White research-paper restraint with sparse OpenAI green signals.' },
  { key: 'linear-app', label: 'Linear', description: 'Near-black software craft with Linear lavender focus states.' },
  { key: 'vercel', label: 'Vercel', description: 'Geist-like monochrome infrastructure UI with blue focus links.' },
  { key: 'stripe', label: 'Stripe', description: 'White fintech surface with deep navy text and Stripe purple action.' },
  { key: 'supabase', label: 'Supabase', description: 'Code-editor dark surfaces with emerald product signals.' },
  { key: 'github-utility', label: 'GitHub', description: 'GitHub dark repo utility with Primer blue and diff semantics.' },
  { key: 'figma', label: 'Figma', description: 'Monochrome creative canvas with Figma color-block energy.' },
  { key: 'spotify', label: 'Spotify', description: 'Immersive music-player dark mode with Spotify green controls.' },
  { key: 'apple', label: 'Apple', description: 'SF Pro light gallery with Action Blue interactions.' },
  { key: 'tesla', label: 'Tesla', description: 'Radically minimal showroom white with Electric Blue CTAs.' },
]
